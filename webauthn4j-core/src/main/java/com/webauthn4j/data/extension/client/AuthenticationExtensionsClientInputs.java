...
public class AuthenticationExtensionsClientInputs<T extends ExtensionClientInput> {
    ...
    @JsonIgnore
    private Map<Class<? extends ExtensionClientInput>, ExtensionClientInput> extensions;
    ...
    @JsonIgnore
    private Map<Class<? extends ExtensionClientInput>, ? extends ExtensionClientInput> getExtensions(){
        if(extensions == null){
            extensions = new HashMap<>();
            if(appid != null){
                extensions.put(FIDOAppIDExtensionClientInput.class, new FIDOAppIDExtensionClientInput(appid));
            }
            if(uvm != null){
                extensions.put(UserVerificationMethodExtensionClientInput.class, new UserVerificationMethodExtensionClientInput(uvm));
            }
            if(credProps != null){
                extensions.put(CredentialPropertiesExtensionClientInput.class, new CredentialPropertiesExtensionClientInput(credProps));
            }
        }
        return extensions;
    }
    ...
    public static class BuilderForAuthentication {
        ...
        public AuthenticationExtensionsClientInputs.BuilderForAuthentication setUnknowns(Map<String, Object> unknowns){
            AssertUtil.notNull(unknowns, "unknowns must not be null.");
            this.unknowns = unknowns;
            return this;
        }
