...
class AuthenticationExtensionsClientInputsConverterTest {
    ...
    void convertRegistrationExtensions_null_test() {
        AuthenticationExtensionsClientInputs<RegistrationExtensionClientInput> value = authenticationExtensionsClientInputsConverter.convertStringToRegistrationExtensions(null);
    ...
    void convertAuthenticationExtensionsToString_test() {
        ...
        assertThat(authenticationExtensionsClientInputsConverter.convertAuthenticationExtensionsToString(extensions)).isEqualTo("{\"appid\":\"test\"}");
    }

    @Test
    void convertAuthenticationExtensionsToString_null_test() {
        assertThat(authenticationExtensionsClientInputsConverter.convertAuthenticationExtensionsToString(null)).isNull();
    }

    @Test
    void convert_test() {
        String source = "{\"appid\":\"dummy\"}";
        AuthenticationExtensionsClientInputs<AuthenticationExtensionClientInput> clientInputs = authenticationExtensionsClientInputsConverter.convertStringToAuthenticationExtensions(source);
    ...
    void convert_with_invalid_extension_test() {
        ...
        AuthenticationExtensionsClientInputs<RegistrationExtensionClientInput> extensions = authenticationExtensionsClientInputsConverter.convertStringToRegistrationExtensions(source);
